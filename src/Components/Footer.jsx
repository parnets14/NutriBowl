        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          >
            <Link to="/" className="flex-shrink-0 flex items-center group cursor-pointer">
              <motion.img 
                ...
                alt="Company Logo"
              />
              <span className="ml-3 text-xl font-bold text-white  md:block">
                Nutri<span className="text-green-500">Bowl</span>
              </span>
            </Link>
          </motion.div>
            <p className="text-gray-400">
              Your complete guide to fitness, weight loss, and weight gain.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><button className="text-gray-400 hover:text-white transition">Recipes</button></li>
              <li><button className="text-gray-400 hover:text-white transition">Workouts</button></li>
              <li><button className="text-gray-400 hover:text-white transition">Calculators</button></li>
            </ul>
          </div>
          <div>
            <h4 className="font-semibold mb-4">Contact</h4>
            <ul className="space-y-2">
              <li className="text-gray-400">info@fitguide.com</li>
